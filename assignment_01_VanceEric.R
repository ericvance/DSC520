...
##assuming here that Tuesday is the third element
week1_sleep[3]

## Create a vector called `week1_sleep_weekdays`
## Assign the weekday values using indice slicing
#note - i'm interpreting weekdays as every day, not M-F
...
students_combined <- matrix(c(student01, student02, student03), ncol = 2)
